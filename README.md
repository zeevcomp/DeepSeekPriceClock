...
- 🕰️ **Analog clock (default)** — a polished, pre-rendered face with silky-smooth hands (≈30 fps sweep) and a **thin, elegant frame that glows green while prices are off-peak and amber during peak hours** (morphing smoothly on every flip). **Amber arcs** additionally mark the expensive peak windows on the dial in your local time
...
4. The **analog clock is the default** — its thin frame glows **green off-peak / amber at peak**, and **amber arcs on the dial mark the expensive hours** in your local time (weekends have none). Click **English / עברית** to switch language or **Digital** for the big digital clock.
